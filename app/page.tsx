...
const IDMAP: Record<number, Meta> = {
  ...
  12000001:{name:'Trappola a Scatto',cat:'trap'},
...
const CAPS2: Record<TH, CapsByName> = {
  10: {
    ...
    "Bomba": { qty: 6, lvl: 7 },
    "Trappola a Scatto": { qty: 6, lvl: 5 },
    "Bomba Gigante": { qty: 5, lvl: 4 },
    "Bomba Aerea": { qty: 5, lvl: 4 },
    "Mina Aerea a Ricerca": { qty: 5, lvl: 3 },
    "Trappola Scheletrica": { qty: 3, lvl: 4 },
  ...
  11: {
    ...
    "Bomba": { qty: 6, lvl: 8 },
    "Trappola a Scatto": { qty: 6, lvl: 5 },
    "Bomba Gigante": { qty: 5, lvl: 5 },
    "Bomba Aerea": { qty: 5, lvl: 5 },
    "Mina Aerea a Ricerca": { qty: 5, lvl: 3 },
    "Trappola Scheletrica": { qty: 3, lvl: 4 },
    "Trappola Tornado": { qty: 1, lvl: 2 },
    "Giga Bomba (solo TH17)": { qty: 0, lvl: 0 }
  },
  12: {
    ...
    "Bomba": { qty: 6, lvl: 8 },
    "Trappola a Scatto": { qty: 8, lvl: 5 },
    "Bomba Gigante": { qty: 6, lvl: 5 },
    "Bomba Aerea": { qty: 6, lvl: 6 },
    "Mina Aerea a Ricerca": { qty: 6, lvl: 3 },
    "Trappola Scheletrica": { qty: 3, lvl: 4 },
    "Trappola Tornado": { qty: 1, lvl: 3 },
    "Giga Bomba (solo TH17)": { qty: 0, lvl: 0 }
  },
  13: {
    ...
    "Arco X (X-Bow)": { qty: 4, lvl: 8 },
    "Torre Infernale": { qty: 3, lvl: 7 },
    ...
    "Bomba": { qty: 7, lvl: 9 },
    "Trappola a Scatto": { qty: 9, lvl: 5 },
    "Bomba Gigante": { qty: 6, lvl: 7 },
    "Bomba Aerea": { qty: 6, lvl: 8 },
    "Mina Aerea a Ricerca": { qty: 7, lvl: 4 },
  ...
  14: {
    ...
    "Bomba": { qty: 8, lvl: 10 },
    "Trappola a Scatto": { qty: 9, lvl: 5 },
    "Bomba Gigante": { qty: 7, lvl: 8 },
    "Bomba Aerea": { qty: 7, lvl: 9 },
    "Mina Aerea a Ricerca": { qty: 8, lvl: 4 },
    "Trappola Scheletrica": { qty: 4, lvl: 4 },
    "Trappola Tornado": { qty: 1, lvl: 3 },
    "Giga Bomba (solo TH17)": { qty: 0, lvl: 0 }
  },
  15: {
    ...
    "Arco X (X-Bow)": { qty: 4, lvl: 10 },
    "Torre Infernale": { qty: 3, lvl: 9 },
    ...
    "Bomba": { qty: 8, lvl: 11 },
    "Trappola a Scatto": { qty: 9, lvl: 5 },
    "Bomba Gigante": { qty: 7, lvl: 9 },
    "Bomba Aerea": { qty: 7, lvl: 10 },
    "Mina Aerea a Ricerca": { qty: 8, lvl: 5 },
    "Trappola Scheletrica": { qty: 4, lvl: 4 },
    "Trappola Tornado": { qty: 1, lvl: 3 },
    "Giga Bomba (solo TH17)": { qty: 0, lvl: 0 }
  },
  16: {
    ...
    "Torre Multi-Ingranaggio (Long Range)": { qty: 1, lvl: 2 },
    "Sputafuoco": { qty: 0, lvl: 0 },
    "Mura (sezioni)": { qty: 325, lvl: 17 },
    "Bomba": { qty: 8, lvl: 12 },
    "Trappola a Scatto": { qty: 9, lvl: 5 },
    "Bomba Gigante": { qty: 7, lvl: 10 },
    "Bomba Aerea": { qty: 7, lvl: 11 },
    "Mina Aerea a Ricerca": { qty: 8, lvl: 6 },
    "Trappola Scheletrica": { qty: 4, lvl: 4 },
    "Trappola Tornado": { qty: 1, lvl: 3 },
    "Giga Bomba (solo TH17)": { qty: 0, lvl: 0 }
  },
  17: {
    ...
    "Casa degli Animali (Pet House)": { qty: 1, lvl: 10 },
    "Castello del Clan": { qty: 1, lvl: 13 },
    "Miniera d’Oro": { qty: 7, lvl: 16 },
    "Collettore d’Elisir": { qty: 7, lvl: 16 },
    ...
    "Cannone": { qty: 7, lvl: 21 },
    "Torre degli Arcieri": { qty: 9, lvl: 21 },
    "Mortaio": { qty: 4, lvl: 16 },
    ...
    "Artiglieria Aquila": { qty: 1, lvl: 7 },
    "Scagliapietre (Scattershot)": { qty: 2, lvl: 5 },
    "Capanna del Costruttore": { qty: 5, lvl: 7 },
    "Torre degli Incantesimi": { qty: 2, lvl: 3 },
    "Monolite": { qty: 1, lvl: 3 },
    "Torre Multi-Arciere": { qty: 2, lvl: 3 },
    "Cannone a palle rimbalzanti": { qty: 2, lvl: 3 },
    "Torre Multi-Ingranaggio (Long Range)": { qty: 1, lvl: 2 },
    "Sputafuoco": { qty: 2, lvl: 2 },
    "Mura (sezioni)": { qty: 325, lvl: 18 },
    "Bomba": { qty: 8, lvl: 13 },
    "Trappola a Scatto": { qty: 9, lvl: 5 },
    "Bomba Gigante": { qty: 8, lvl: 11 },
    "Bomba Aerea": { qty: 7, lvl: 12 },
    "Mina Aerea a Ricerca": { qty: 9, lvl: 7 },
    "Trappola Scheletrica": { qty: 4, lvl: 4 },
    "Trappola Tornado": { qty: 1, lvl: 3 },
    "Giga Bomba (solo TH17)": { qty: 1, lvl: 3 }
  }
};
...
const WAR_ORDER = [
  ...
  'Trappola Tornado','Mina Aerea a Ricerca','Bomba Gigante','Bomba Aerea','Trappola Scheletrica','Trappola a Scatto','Bomba','Giga Bomba (solo TH17)',
